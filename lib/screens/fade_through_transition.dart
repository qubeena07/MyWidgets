...
import 'open_container_transform.dart';
          ...
          children: <Widget>[
            Column(
              ...
              children: <Widget>[
                Expanded(
                  child: Container(
                    color: const Color.fromARGB(66, 195, 195, 195),
                    child: Padding(
                      padding: const EdgeInsets.all(30.0),
                      child: Ink.image(
                        image: const AssetImage('assets/beach.jpeg'),
                      ),
                    ),
                  ),
                ),
            ...
            InkWell(
              ...
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const OpenContainerTransform(),
                    ));
              },
            ),
          ],
